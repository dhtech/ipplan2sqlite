...
class TestFirewall(BaseTestCase, unittest.TestCase):
    ...
    def testServerClientRule(self):
        ...
        self.assertEqual(len(rules), 1, "Wrong number of firewall rules")
        ...
        self.assertEqual(rule[2], 'event', "Wrong flow")
        self.assertEqual(
            rule[3],
            '2022/tcp',
    ...
    def testServerClientRuleNat(self):
        ...
        firewall.build(self.packages, self.c)
        rules = self._query('SELECT * FROM firewall_rule_ip_level')
        self.assertEqual(len(rules), 3, "Wrong number of firewall rules")
        ...
        self.assertEqual(non_nat_rule1[0], 'jumpgate1.event.dreamhack.se',
            "Wrong source host")
        self.assertEqual(non_nat_rule1[1], 'ddns1.event.dreamhack.se',
            "Wrong destination host")
        self.assertEqual(non_nat_rule1[2], 'event', "Wrong flow")
        self.assertEqual(non_nat_rule1[3], '2022/tcp',
            "Wrong destination port/protocol")

        self.assertEqual(nat_rule[0], 'nat.event.dreamhack.se',
            "Wrong source host")
        self.assertEqual(nat_rule[1], 'ddns1.event.dreamhack.se',
            "Wrong destination host")
        self.assertEqual(nat_rule[2], 'event', "Wrong flow")
        self.assertEqual(nat_rule[3], '2022/tcp',
            "Wrong destination port/protocol")

        self.assertEqual(non_nat_rule2[0], 'jumpgate2.event.dreamhack.se',
            "Wrong source host")
        self.assertEqual(non_nat_rule2[1], 'ddns1.event.dreamhack.se',
            "Wrong destination host")
        self.assertEqual(non_nat_rule2[2], 'event', "Wrong flow")
        self.assertEqual(non_nat_rule2[3], '2022/tcp',
            "Wrong destination port/protocol")
    ...
    def testPublicRule(self):
        ...
        firewall.build(self.packages, self.c)
        rules = self._query('SELECT * FROM firewall_rule_ip_level')
        self.assertEqual(len(rules), 8, "Wrong number of firewall rules")
        ...
        self.assertEqual(len(rules), 2, "Wrong number of firewall rules")
        ...
        self.assertEqual(len(rule), 1, "Wrong number of firewall rules")
    ...
    def testWorldRule(self):
        ...
        self.assertEqual(rule[0], 'ANY', "Wrong source host")
        self.assertEqual(
            rule[1],
    ...
    def testLocalRule(self):
        ...
        rule = rules[0]
        self.assertEqual(rule[0], 1, "Wrong rule id")
        self.assertEqual(rule[2], 'EVENT@TECH-SRV-6-JUMPNET',
            "Wrong source host")
        self.assertEqual(
            rule[3],
            '77.80.231.128/28',
